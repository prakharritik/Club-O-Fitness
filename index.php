  ...
  <nav class="flex items-center justify-between flex-wrap bg-teal p-6">
    ...
    <div  id="menu" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
      <div class="text-sm sm:flex-grow">
        ...
        <a href="training.html" class="no-underline block mt-4 sm:inline-block sm:mt-0 text-teal-lighter hover:text-white">
          Training
        </a>
       <a href="writeblog.php" class="ml-4 no-underline block mt-4 sm:inline-block sm:mt-0 text-teal-lighter hover:text-white">
          WriteBlog
        </a>
        <a href="docLogin.php" class="ml-4 no-underline block mt-4 sm:inline-block sm:mt-0 text-teal-lighter hover:text-white">
          Doctor's login
        </a>
...
<div class="carousel relative shadow-2xl bg-white">
  <div class="carousel-inner relative overflow-hidden w-full">
    ...
    <div class="carousel-item absolute opacity-0" style="height:80vh;">
      <img src="images/fit3.jpg" alt="" style="width: 100%; height: 100% ">
    ...
    <div class="carousel-item absolute opacity-0" style="height:80vh;">
      <img src="images/fittt2.jpg" alt="" style="width: 100%; height: 100% ">
    ...
    <div class="carousel-item absolute opacity-0" style="height:80vh;">
      <img src="images/fitt1.jpg" alt="" style="width: 100%; height: 100% ">
...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-18 mx-auto">
    <div class="flex flex-col">
      <h1 style="text-align: center;font-size: 60px;font-family: Georgia, serif;font-color:black"><b>Features</b></h1>
      
    </div>
    <br>
    <br>
    <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
      <div class="p-4 md:w-1/3 sm:mb-0 mb-6" style="box-shadow: -9px 13px 5px 13px rgba(0,0,0,0.75);
-webkit-box-shadow: -9px 13px 5px 13px rgba(0,0,0,0.75);
-moz-box-shadow: -9px 13px 5px 13px rgba(0,0,0,0.75);">
        <div class="rounded-lg h-64 overflow-hidden">
          <img alt="content" class="object-cover object-center h-full w-full" src="images/care.jpg">
        </div>
        <h2 class="text-xl font-medium title-font text-gray-900 mt-5" style="font-family: Georgia, serif;"><b>Consult the Doctor</b></h2>
        <p class="text-base leading-relaxed mt-2" style=" font-family: Georgia, serif; font-size: 19px">It is always better to have some knowledge regarding your health and we are here to help you in boosting up your fitness knowledge. You can consult from our online Doctors.</p>

                <?php
        if(isset($_SESSION['uid']))
        echo '        <a class="text-indigo-500 inline-flex items-center mt-3" href="postproblem.php">Learn More
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
            <path d="M5 12h14M12 5l7 7-7 7"></path>
          </svg>
        </a>';
        else echo '        <a class="text-indigo-500 inline-flex items-center mt-3" href="login.html">Learn More
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
            <path d="M5 12h14M12 5l7 7-7 7"></path>
          </svg>
        </a>';
      ...
      <div class="p-4 md:w-1/3 sm:mb-0 mb-6">
        <div class="rounded-lg h-64 overflow-hidden">
          <img alt="content" class="object-cover object-center h-full w-full" src="images/meditation.jpg">
        </div>
        <h2 class="text-xl font-medium title-font text-gray-900 mt-5" style="font-family: Georgia, serif;"><b>Meditation Tips</b></h2>
        <p class="text-base leading-relaxed mt-2" style=" font-family: Georgia, serif; font-size: 19px">The healing power of depression is Medidation. You can find happiness in yourself by doing meditation. We are here to give you some meditation tips.</p>
        <a href="meditation.html" class="text-indigo-500 inline-flex items-center mt-3">Learn More
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
            <path d="M5 12h14M12 5l7 7-7 7"></path>
          </svg>
        </a>
...
-moz-box-shadow: 9px 13px 5px 13px rgba(0,0,0,0.75);">
        <div class="rounded-lg h-64 overflow-hidden">
          <img alt="content" class="object-cover object-center h-full w-full" src="images/c2.jpg">
        </div>
        <h2 class="text-xl font-medium title-font text-gray-900 mt-5" style=" font-family: Georgia, serif;"><b>Create the Schedule</b></h2>
        <p class="text-base leading-relaxed mt-2" style=" font-family: Georgia, serif; font-size: 19px">Doing anything with the proper schedule is the best way to spend a day. We are here to make your schedule according to your comfort level and choice.</p>
        <?php
        if(isset($_SESSION['uid']))
        echo '        <a class="text-indigo-500 inline-flex items-center mt-3" href="dash.php">Learn More
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
            <path d="M5 12h14M12 5l7 7-7 7"></path>
          </svg>
        </a>';
...
<br>
    ...
    <section class="bg-gray-100 dark:bg-gray-900 lg:py-12 lg:flex lg:justify-center">
        <div class="bg-white dark:bg-gray-800 lg:mx-8 lg:flex lg:max-w-5xl lg:shadow-lg lg:rounded-lg" style="box-shadow: -24px 3px 5px 13px rgba(0,0,0,0.75);
-webkit-box-shadow: -24px 3px 5px 13px rgba(0,0,0,0.75);
-moz-box-shadow: -24px 3px 5px 13px rgba(0,0,0,0.75);">
            <div class="lg:w-1/2">
                <img src="images/fit7.jpg">
            </div>

            <div class="max-w-xl px-6 py-12 lg:max-w-5xl lg:w-1/2">
                <h2 class="text-2xl font-bold text-gray-800 dark:text-white md:text-3xl" style=" font-family: Georgia, serif;">Earn Badges</h2>
                <p class="mt-4 text-gray-600 dark:text-gray-400" style=" font-family: Georgia, serif; font-size: 19px;">Having trouble finding the motivation to make it to your workouts? We could all use a little encouragement and reminder of our success sometimes. To help you out, we added badges to our app. With badges, you'll get personalized reminders of our fitness milestones to help keep you motivated and stay on top of your goals.</p>
                
                <div class="mt-8">
                    <a href="#" class="px-5 py-2 font-semibold text-gray-100 transition-colors duration-200 transform bg-gray-900 rounded-md hover:bg-gray-700">Start Earning</a>
                </div>
            </div>
        </div>
    </section> 
...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
   ...
   <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
        <h1 style="text-align: center; font-family: Georgia, serif; font-size: 50px;font-color:black;"><b>Quick Reads</b></h1>
         <a href="blog.php"><button class="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Read Blogs</button></a>
      </div>
      <p class="lg:w-1/2 w-full leading-relaxed text-gray-500" style=" font-family: Georgia, serif; font-size: 19px; font-color:black">The blogs listed here provide information from real and quality sources, meaning people who are truly engaged in the health and fitness industry. You will not be charged for the information you need. We understand that paying a hefty sum to read about fitness tips or being forced to buy fancy equipment also prevents you from sticking to your fitness goals.</p>
    </div>
    <div class="flex flex-wrap -m-4">
      <div class="xl:w-2/4 md:w-1/2 p-4" style="box-shadow: -6px -9px 5px 13px rgba(0,0,0,0.75);
-webkit-box-shadow: -6px -9px 5px 13px rgba(0,0,0,0.75);
-moz-box-shadow: -6px -9px 5px 13px rgba(0,0,0,0.75);">
        <div class="bg-gray-100 p-6 rounded-lg">
          <img class="h-70 rounded w-full object-cover object-center mb-6" src="images/fit11.jpg" alt="content">
          
        </div>
      </div>
      <div class="xl:w-2/4 md:w-1/2 p-4" style="box-shadow: 9px 13px 5px 13px rgba(0,0,0,0.75);
-webkit-box-shadow: 9px 13px 5px 13px rgba(0,0,0,0.75);
-moz-box-shadow: 9px 13px 5px 13px rgba(0,0,0,0.75);">
        <div class="bg-gray-100 p-6 rounded-lg">
          <img class="h-70 rounded w-full object-cover object-center mb-6" src="images/fit13.jpeg" alt="content">
        </div>
      </div>
...
<section class="text-gray-600 body-font">
  ...
  <h1 style="text-align: center;font-size: 60px;font-family: Georgia, serif;text-shadow: 3px -4px 2px rgba(0,0,0,0.6);">Why To Join Us?</h1>
  <div class="row">
  <div class="col-lg-4 col-md-12"><img src="images/care.png"></div>
  <div class="col-lg-4 col-md-12"><img src="images/coach.png"></div>
  <div class="col-lg-4 col-md-12"><img src="images/connect.png"></div>
 ...
 <br><br><br>
    ...
    <footer style='margin-top: 50px;background-color: #464B6A' class="flex flex-col items-center justify-between px-6 py-2 bg-white dark:bg-gray-800 sm:flex-row" >
        <a href="#" class="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">Club'O'Fitness</a>
