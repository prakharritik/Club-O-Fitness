...
if ( isset($_POST['email']) && isset($_POST['pass']) ) {
 $check = $_POST['pass'];
    $stmt = $pdo->prepare('SELECT * FROM doctors WHERE email = :em AND password = :pw');
...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
    ...
    <link rel="stylesheet" href="styles.css"><script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js" integrity="sha512-894YE6QWD5I59HgZOGReFYm4dnWc1Qt5NtvYSaNcOP+u1T9qYdvdihz0PPSiiqn/+/3e7Jo4EaG7TubfWGUrMQ==" crossorigin="anonymous"></script><link href="https://unpkg.com/tailwindcss@^2.0.4/dist/tailwind.min.css" rel="stylesheet">
  ...
  <nav class="flex items-center justify-between flex-wrap bg-teal p-6">
    ...
    <div  id="menu" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
      ...
      <div>
        ...
        <h1 class="text-center display-4">Doctor's Login</h1>
      <section class="mt-5">
    <div class="container active">

 <div class="user signupBx row" style="left:20px;">
<div class="col-12 col-lg-6">
        ...
        <div class="col-12 col-lg-6">
          <lottie-player src="https://assets8.lottiefiles.com/private_files/lf30_4FGi6N.json"  background="transparent"  speed="1"  style="width: 100%; height: 300px;"  loop  autoplay></lottie-player></div>
