...
$stmt = $pdo->prepare("SELECT * FROM blog b join users u on b.uid=u.uid");
$stmt->execute();
...
<ul class="cards">
 ...
 echo '<li>
    <a href="readblog.php?bid='.$key['bid'].'" class="card">
      <img class="card__image" src="'.$key['image'].'" alt="" />
      <div class="card__overlay">
        <div class="card__header">
          <svg class="card__arc" xmlns="http://www.w3.org/2000/svg"><path /></svg>                     
          <img class="card__thumb" src="https://i.imgur.com/7D7I6dI.png" alt="" />
          <div class="card__header-text">
            <h3 class="card__title">'.$key['title'].'</h3>            
            <span class="card__status">'.$key['uname'].'</span>
          </div>
        </div>
        <p class="card__description">'.$key['des'].'</p>
      </div>
    </a>      
  </li>';}
  ?>
